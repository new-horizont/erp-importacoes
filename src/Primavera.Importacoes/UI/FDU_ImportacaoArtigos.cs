...
{
    public partial class FDU_ImportacaoArtigos : CustomForm
    {
        ClsArtigo motor;

        

        public FDU_ImportacaoArtigos()
        {
            InitializeComponent();
        }

        private void FDU_ImportacaoArtigos_Load(object sender, EventArgs e)
        {
            try
            {
                motor = new ClsArtigo(BSO, PSO);
            }
            catch (Exception ex)
            {
